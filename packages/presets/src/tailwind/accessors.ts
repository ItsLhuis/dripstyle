 ...
 */
export function fontWeight(): (typeof fontWeightTokens)["normal"]
export function fontWeight<K extends FontWeightAlias>(key: K): (typeof fontWeightTokens)[K]
export function fontWeight(key?: FontWeightAlias): (typeof fontWeightTokens)[FontWeightAlias] {
  "worklet"
