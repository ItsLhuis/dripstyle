...
const EXAMPLES = [
  ...
  {
    route: "/benchmark/inline-functions",
    title: "Inline Function Styles",
    description: "Function entries returning view/text styles with typed args"
  },
  {
